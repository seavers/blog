...
刚学习html5时, 为了练手, 基于html5写了版仙剑, 试玩点击[这里](http://dahai.online/xianjian/) 或 [github](http://xianjian.github.io/) 
...
[![xianjian]({{site.baseurl}}/uploads/xianjian.png)](http://dahai.online/xianjian/)

刚开始下载时, 速度有点慢, 请耐心等待, 后续再更改算法, 如果本地玩, 可以git clone哦~~

  * 在线试玩,可以使用 [github](http://xianjian.github.io) 或者 [博客内](http://dahai.online/xianjian/)
